...
require(["cbtree/Tree",
	...
	//Biomass Maps	
	if (!LAYOUT_DEBUG) var biomassChecked = true;
	...
	for (var cur in countyMaps){
		store.add(({id: 'cover/'+countyMaps[cur].mapId, name: cur+" (1m)", url: servicesUrl+'cover/'+countyMaps[cur].mapId+'/MapServer', parent: 'cover'}));
		store.add(({id: 'height/'+countyMaps[cur].mapId, name: cur+" (1m)", url: servicesUrl+'height/'+countyMaps[cur].mapId+'/MapServer', parent: 'height'}));
	}
